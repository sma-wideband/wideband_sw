...
parser.add_argument('-r', '--reference', dest='reference', metavar='REFERENCE', type=str, default='3,0,1',
                    help='use ANT,POL,CHUNK as a REFERENCE; POL and CHUNK are either 0 or 1 (default=3,0,1')
...
parser.add_argument('--calibrate-vlbi', dest='calibrate_vlbi', nargs='?', const='low', default='low',
